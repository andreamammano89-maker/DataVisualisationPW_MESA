var cities = {
  Rome: {
    ...
    upi: '0.27', upiSub: 'mean urban pressure index',
    dom: '39.2%', domSub: 'of all listings',
    casual: 41.6, semi: 29.0, pro: 29.4,
    color: '#8B3A2A',
    insight: 'In Rome, professional hosts are only 5.1% of all hosts yet control <strong>29.4% of all listings</strong>. The top 1% of hosts alone account for 13.9% of the market. Combined with semi-professional hosts, 58.4% of Rome\'s supply is managed by multi-listing operators, a market that has moved well beyond peer-to-peer.'
  },
  Copenhagen: {
    price: '161 EUR', priceSub: 'higher than Rome',
    avail: '115 days', availSub: '31% of the year',
    d180: '38.4%', d180Sub: 'more occasional use',
    upi: '0.44', upiSub: 'mean urban pressure index',
    dom: '20.0%', domSub: 'of all listings',
    casual: 85.3, semi: 6.9, pro: 7.8,
    color: '#2A5C45',
    insight: 'In Copenhagen, casual hosts manage <strong>85.3% of all listings</strong>. The top 1% of hosts control just 9.1% of the market, and professional hosts account for only 7.8% of supply. Copenhagen\'s platform still functions largely as a peer-to-peer exchange, a direct result of tighter housing regulation.'
  }
};
...
var hats = {
  white: {
    ...
    alt: 'White hat scatter plot showing professional host share vs UPI for both cities with 95% confidence intervals',
    title: 'White hat: honest representation',
    desc: 'Scatter plot with confidence intervals, correlation statistics, and a causal disclaimer. Both cities shown.',
    border: '#2A5C45',
    text: '<strong>Why this is white hat:</strong> Both cities are shown simultaneously, preventing selective presentation of the stronger result. Both axes are anchored at zero. 95% confidence intervals are shaded around each regression line, making uncertainty visible. Pearson correlation coefficients and p-values are annotated directly on the chart. The caption states explicitly that correlation does not imply causation and identifies the UPI as an author-constructed composite rather than an official statistic. A reader who looks carefully walks away with an accurate picture of both the relationship and its limits.'
  },
  black: {
    img: 'https://romevscopenhagen.wpcomstaging.com/wp-content/uploads/2026/05/black_hat.jpg',
    alt: 'Black hat dual-axis line chart engineered to imply causation between professionalisation and urban pressure',
    title: 'Black hat: misleading representation',
    desc: 'Dual-axis line chart with engineered neighbourhood ordering that implies causation. Copenhagen only.',
    border: '#8B3A2A',
    text: '<strong>Why this is black hat:</strong> The chart shows only Copenhagen, hiding the weaker Rome correlation. Two independent y-axes are scaled so the lines appear to move in lockstep. Neighbourhoods are sorted by the average of their UPI rank and professional host share rank, maximising visual co-movement. No confidence intervals or causal disclaimers are included. Every data point is accurate, but the combination of selective city choice, engineered ordering, and dual-axis scaling produces an impression that far exceeds what the data supports. This is the kind of chart to watch for in policy briefings.'
  }
};
